...
public class RunManager {
    ...
    public static final String ACTION_LOCATION = "com.learninghorizon.skibuddy.tracker.ACTION_LOCATION";

    //private static final String TEST_PROVIDER = "TEST_PROVIDER";
    private static final String TEST_PROVIDER = "GPS_PROVIDER";
    ...
    public void startLocationUpdates() {
        ...
        mLocationManager.requestLocationUpdates(provider, 0, 1, pi);
    }
